...
**Unity Editor 6000.6.2f1**, installed locally via Unity Hub. Use this exact
version; do not assume a different Unity 6 release behaves identically.

## Opening the project

1. Install Unity Hub and Unity Editor **6000.6.2f1** (matching version required).
...
`~/Unity/Hub/Editor/6000.6.2f1/Editor/Unity` on Linux. Both commands run
